...
public class PriceEntity {
  ...
  @InjectSimpleArrayRes(summaryArrayRes = R.array.pay_percent_2, valueArrayRes = R.array.pay_integer_2)
  ...
  @InjectSimpleArrayRes(summaryArrayRes = R.array.loan_type, valueArrayRes = R.array.loan_type_value)
  int aLoanType;
  ...
  String aLoanAmount;
  @InjectSimpleArrayRes(summaryArrayRes = R.array.loan_year, valueArrayRes = R.array.loan_year_value)
